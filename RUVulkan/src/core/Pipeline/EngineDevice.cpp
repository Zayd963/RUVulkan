...
std::vector<const char *> EngineDevice::getRequiredExtensions() {
  ...
  SDL_Vulkan_GetInstanceExtensions(window.GetWindow(), &SDLExtensionCount, nullptr);
     


  std::vector<const char*> extensions = { VK_EXT_DEBUG_REPORT_EXTENSION_NAME };

  size_t additionalExetensionCount = extensions.size();
  extensions.resize(additionalExetensionCount + SDLExtensionCount);

  SDL_Vulkan_GetInstanceExtensions(window.GetWindow(), &SDLExtensionCount, extensions.data() + additionalExetensionCount);
